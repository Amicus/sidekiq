...
class TestClient < MiniTest::Unit::TestCase
  ...
  ##TODO: this now uses a real redis - needs cleanup
  #describe 'with mock data_store' do
  #  before do
  #    #Sidekiq.redis = REDIS
  #    #Sidekiq.redis {|c| c.flushdb }
  #    @data_store = MiniTest::Mock.new
  #    def @data_store.enqueue(*); true; end
  #    def @data_store.push_job(*); true; end
  #    def @data_store.registered_queues(*); true; end
  ...
  #    Sidekiq.data_store.expect :push_job, 1, ['queue:foo', String]
  ...
  #    @data_store.expect :push_job, 1, ['queue:default', String]
  ...
  #    @data_store.expect :push_job, ['queue:default', String]
  #    pushed = MyWorker.perform_async(1, 2)
  #    refute pushed
  #    @redis.verify
  #  end
  ...
  #    @data_store.expect :push_job, 1, ['queue:flimflam', String]
  #    pushed = QueuedWorker.perform_async(1, 2)
  #    assert pushed
  #    @redis.verify
  #  end
  #
  #  #TODO: this used to look at smember and try to return something different
  #  # should it be returning ['queues'] for ['bob'] ???
  #  it 'retrieves queues' do
  #    @data_store.expect :registered_queues, ['bob'], ['queues']
  #    assert_equal ['bob'], Sidekiq::Client.registered_queues
  #  end
  #
  #  it 'retrieves workers' do
  #    @data_store.expect :registered_workers, ['bob'], ['workers']
